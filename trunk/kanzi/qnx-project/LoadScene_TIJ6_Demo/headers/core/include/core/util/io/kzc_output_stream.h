...
kzsException kzcOutputStreamCreateToFile(const struct KzcMemoryManager* memoryManager, kzString filePath,
...
kzsException kzcOutputStreamCreateToMemory(const struct KzcMemoryManager* memoryManager, kzByte* buffer, kzUint size,
                                           enum KzcIOStreamEndianness endianness, struct KzcOutputStream** out_outputStream);
 ...
 */
kzsException kzcOutputStreamCreateToStream(const struct KzcMemoryManager* memoryManager, struct KzcOutputStream* targetOutputStream, kzInt targetLength,
                                           enum KzcIOStreamEndianness endianness, struct KzcOutputStream** out_outputStream);

/** Creates an output stream using custom write functions. */
kzsException kzcOutputStreamCreateCustom(const struct KzcMemoryManager* memoryManager, void* customData,
 ...
 */
kzsException kzcOutputStreamWrite(struct KzcOutputStream* outputStream, kzUint byteCount, const kzByte* bytes, kzUint* out_bytesWrittenCount);
