...
kzsException kzcInputStreamCreateFromFile(const struct KzcMemoryManager* memoryManager, kzString filePath,
...
kzsException kzcInputStreamCreateFromResource(const struct KzcMemoryManager* memoryManager, kzString resourcePath,
                                              enum KzcIOStreamEndianness endianness, struct KzcInputStream** out_inputStream);

/** Creates an input stream pointing to a given memory buffer of given size. */
kzsException kzcInputStreamCreateFromMemory(const struct KzcMemoryManager* memoryManager, const kzByte* buffer, kzUint size,
                                            enum KzcIOStreamEndianness endianness, struct KzcInputStream** out_inputStream);
 ...
 */
kzsException kzcInputStreamCreateFromStream(const struct KzcMemoryManager* memoryManager, struct KzcInputStream* targetInputStream, kzInt targetLength,
                                            enum KzcIOStreamEndianness endianness, struct KzcInputStream** out_inputStream);

/** Creates an input stream using custom read functions. */
kzsException kzcInputStreamCreateCustom(const struct KzcMemoryManager* memoryManager, void* customData,
 ...
 */
kzsException kzcInputStreamRead(struct KzcInputStream* inputStream, kzUint byteCount, kzUint* out_bytesReadCount, kzByte* out_bytes);

/** Skips the given amount of bytes in an input stream. */
kzsException kzcInputStreamSkip(struct KzcInputStream* inputStream, kzUint skipByteCount);
...
kzsException kzcInputStreamReadU16Array(struct KzcInputStream* inputStream, kzUint valueCount, kzU16* values);
...
kzsException kzcInputStreamReadS16Array(struct KzcInputStream* inputStream, kzUint valueCount, kzS16* values);
...
kzsException kzcInputStreamReadU32Array(struct KzcInputStream* inputStream, kzUint valueCount, kzU32* values);
...
kzsException kzcInputStreamReadS32Array(struct KzcInputStream* inputStream, kzUint valueCount, kzS32* values);
...
kzsException kzcInputStreamReadFloatArray(struct KzcInputStream* inputStream, kzUint valueCount, kzFloat* values);
...
kzsException kzcInputStreamReadAllBytes(struct KzcInputStream* inputStream, const struct KzcMemoryManager* memoryManager,
...
kzsException kzcInputStreamReadText(struct KzcInputStream* inputStream, const struct KzcMemoryManager* memoryManager,
 ...
 */
kzsException kzcInputStreamReadTextLines(struct KzcInputStream* inputStream, const struct KzcMemoryManager* memoryManager,
