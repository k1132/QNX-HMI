...
#define KZS_OPENGL_MAJOR 0 /**< Required major version. */
...
#define KZS_GL_LINK_STATUS                      0
#define KZS_GL_INFO_LOG_LENGTH                  0
#define KZS_GL_COMPILE_STATUS                   0
#define KZS_GL_SHADING_LANGUAGE_VERSION         0
#define KZS_GL_ACTIVE_UNIFORMS                  0

#define KZS_GL_MAX_TEXTURE_IMAGE_UNITS          8
#define KZS_GL_MAX_VERTEX_ATTRIBS               8
#define KZS_GL_SHADER_COMPILER                  0
...
#define KZS_GL_INCR_WRAP                      0x1E04
#define KZS_GL_DECR_WRAP                      0x1E05
...
#define KZS_GL_TEXTURE_WRAP_R                 0x2803
...
/*------------------------------------------------------------------------*
* required EXT extension tokens
*------------------------------------------------------------------------*/

/* EXT_texture_filter_anisotropic */
#define KZS_GL_MAX_ANISOTROPY                 0x84FE
#define KZS_GL_MAX_TEXTURE_MAX_ANISOTROPY     0x84FF
...
/* KZS_GL_OES_get_program_binary */
#ifndef KZS_GL_OES_get_program_binary
