...
#define KZS_OPENGL_MINOR 1 /**< Required minor version. */
...
#define KZS_GL_UNIFORM_BUFFER                 GL_UNIFORM_BUFFER
#define KZS_GL_UNIFORM_BUFFER_BINDING         GL_UNIFORM_BUFFER_BINDING
...
#define KZS_GL_NUM_PROGRAM_BINARY_FORMATS     GL_NUM_PROGRAM_BINARY_FORMATS
#define KZS_GL_PROGRAM_BINARY_FORMATS         GL_PROGRAM_BINARY_FORMATS
...
#define KZS_GL_DEPTH24_STENCIL8 GL_DEPTH24_STENCIL8_EXT

#define KZS_GL_DEPTH_STENCIL GL_DEPTH_STENCIL
...
#ifdef KZS_GL_UNIFORM_BUFFER_SUPPORTED
...
{
KZS_OPENGL_CALL_BEGIN
    kzUint index = glGetUniformBlockIndex(program, uniformBlockName);
    kzsGlErrorTest();
...
#ifdef KZS_GL_MAP_BUFFER_RANGE_SUPPORTED
