/**
* \file
* Desktop OpenGL 4.3 wrappers.
* 
* Copyright 2008-2014 by Rightware. All rights reserved.
*/
#ifndef KZS_OPENGL43_H
#define KZS_OPENGL43_H


#include "kzs_opengl_base.h"

/* This is currently needed as PC-lint configuration doesn't support Windows and GL headers. */
#if KZ_OPENGL_VERSION == KZ_OPENGL_4_3
...
#define KZS_OPENGL_MAJOR 4 /**< Required major version. */
#define KZS_OPENGL_MINOR 3 /**< Required minor version. */
...
#define KZS_GL_TEXTURE_WRAP_R                 GL_TEXTURE_WRAP_R
...
#define KZS_GL_READ_FRAMEBUFFER               GL_READ_FRAMEBUFFER
#define KZS_GL_DRAW_FRAMEBUFFER               GL_DRAW_FRAMEBUFFER

#define KZS_GL_RGBA4                          GL_RGBA4
#define KZS_GL_RGB5_A1                        GL_RGB5_A1
#define KZS_GL_RGB565                         GL_RGB565
#define KZS_GL_DEPTH_COMPONENT32F             GL_DEPTH_COMPONENT32F
#define KZS_GL_DEPTH_COMPONENT32              GL_DEPTH_COMPONENT32
#define KZS_GL_DEPTH_COMPONENT24              GL_DEPTH_COMPONENT24
#define KZS_GL_DEPTH_COMPONENT16              GL_DEPTH_COMPONENT16
#define KZS_GL_DEPTH24_STENCIL8               GL_DEPTH24_STENCIL8
...
#define KZS_GL_COLOR_ATTACHMENT1              GL_COLOR_ATTACHMENT1
#define KZS_GL_COLOR_ATTACHMENT2              GL_COLOR_ATTACHMENT2
#define KZS_GL_COLOR_ATTACHMENT3              GL_COLOR_ATTACHMENT3
...
#define KZS_GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS         GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS_EXT
#endif
...
#define KZS_GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER 
#define KZS_GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER 
#define KZS_GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE
#define KZS_GL_FRAMEBUFFER_UNSUPPORTED GL_FRAMEBUFFER_UNSUPPORTED 
...
#define KZS_GL_INVALID_INDEX GL_INVALID_INDEX

#define KZS_GL_UNIFORM_BLOCK_BINDING GL_UNIFORM_BLOCK_BINDING
#define KZS_GL_UNIFORM_BLOCK_DATA_SIZE GL_UNIFORM_BLOCK_DATA_SIZE
#define KZS_GL_UNIFORM_BLOCK_NAME_LENGTH GL_UNIFORM_BLOCK_NAME_LENGTH
#define KZS_GL_UNIFORM_BLOCK_ACTIVE_UNIFORMS GL_UNIFORM_BLOCK_ACTIVE_UNIFORMS
#define KZS_GL_UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES GL_UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES
#define KZS_GL_UNIFORM_OFFSET GL_UNIFORM_OFFSET
#define KZS_GL_UNIFORM_ARRAY_STRIDE GL_UNIFORM_ARRAY_STRIDE
#define KZS_GL_UNIFORM_MATRIX_STRIDE GL_UNIFORM_MATRIX_STRIDE
#define KZS_GL_UNIFORM_SIZE GL_UNIFORM_SIZE
#define KZS_GL_UNIFORM_TYPE GL_UNIFORM_TYPE
...
#define KZS_GL_MAP_READ_BIT GL_MAP_READ_BIT
#define KZS_GL_MAP_WRITE_BIT GL_MAP_WRITE_BIT
#define KZS_GL_MAP_INVALIDATE_RANGE_BIT GL_MAP_INVALIDATE_RANGE_BIT
#define KZS_GL_MAP_INVALIDATE_BUFFER_BIT GL_MAP_INVALIDATE_BUFFER_BIT
#define KZS_GL_MAP_FLUSH_EXPLICIT_BIT GL_MAP_FLUSH_EXPLICIT_BIT
#define KZS_GL_MAP_UNSYNCHRONIZED_BIT GL_MAP_UNSYNCHRONIZED_BIT
...
KZ_INLINE void kzsGlDrawBuffer(GLenum mode)
{
    KZS_OPENGL_CALL_BEGIN
        glDrawBuffer(mode);
        kzsGlErrorTest();
...
KZ_INLINE void kzsGlDrawBuffers(kzUint count, const kzUint* bufs)
{
    KZS_OPENGL_CALL_BEGIN
...
KZ_INLINE void kzsGlBlitFramebuffer(kzInt xs0, kzInt ys0, kzInt xs1, kzInt ys1, 
                                    kzInt xt0, kzInt yt0, kzInt xt1, kzInt yt1, 
                                    kzUint mask, kzInt filter)
{
    KZS_OPENGL_CALL_BEGIN
        glBlitFramebuffer(xs0, ys0, xs1, ys1, xt0, yt0, xt1, yt1, mask, filter);
        kzsGlErrorTest();
    KZS_OPENGL_CALL_END
}


KZ_INLINE void kzsGlRenderbufferStorageMultisample(kzUint target, kzUint samples, kzUint internalformat, kzInt width, kzInt height)
{
    KZS_OPENGL_CALL_BEGIN
