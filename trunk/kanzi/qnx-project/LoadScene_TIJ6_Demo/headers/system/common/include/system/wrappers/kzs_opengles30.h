/**
* \file
* OpenGL es 3.0 wrappers.
* 
* Copyright 2008-2012 by Rightware. All rights reserved.
*/
#ifndef KZS_OPENGLES_30_H
#define KZS_OPENGLES_30_H
...
#if KZ_OPENGL_VERSION == KZ_OPENGL_ES_3_0
...
#define ES_FUNCTION 1


#define KZS_OPENGL_MAJOR 3 /**< Required major version. */
...
static void kzsGlErrorNotify(GLenum error)
{
    ...
    else if(error == GL_INVALID_FRAMEBUFFER_OPERATION)
    {
        ...
        kzsLog(KZS_LOG_LEVEL_WARNING, "GL_INVALID_FRAMEBUFFER_OPERATION");
    }
    else
    {
...
#define KZS_GL_FRAMEBUFFER_UNDEFINED GL_FRAMEBUFFER_UNDEFINED
#define KZS_GL_FRAMEBUFFER_UNSUPPORTED GL_FRAMEBUFFER_UNSUPPORTED
...
#define KZS_GL_SAMPLES_PASSED GL_ANY_SAMPLES_PASSED
#define KZS_GL_QUERY_RESULT GL_QUERY_RESULT

KZ_INLINE void kzsGlBeginQuery(kzUint target, kzUint id)
{
...
KZ_INLINE void kzsGlEndQuery(kzUint target)
{   
    KZS_OPENGL_CALL_BEGIN
        glEndQuery(target);
    kzsGlErrorTest();
...
KZ_INLINE void kzsGlGenQueries(GLsizei n, GLuint *ids)
{   
    KZS_OPENGL_CALL_BEGIN
        glGenQueries(n, ids);
    kzsGlErrorTest();
...
KZ_INLINE void kzsGlDeleteQueries(GLsizei n, GLuint *ids)
{   
    KZS_OPENGL_CALL_BEGIN
...
KZ_INLINE void kzsGlGetQueryObjectuiv(kzUint id, kzUint pname, kzUint *params)
{
    KZS_OPENGL_CALL_BEGIN
...
KZ_INLINE void kzsGlDrawArraysInstanced(kzUint mode, kzInt first, kzInt count, kzUint instances)
{
    KZS_OPENGL_CALL_BEGIN
...
KZ_INLINE void kzsGlReadBuffer(kzUint mode)
{
    KZS_OPENGL_CALL_BEGIN
        glReadBuffer(mode);
    kzsGlErrorTest();
...
KZ_INLINE void kzsGlInvalidateFramebuffer(kzUint target, kzUint num, kzUint* targetsEnum)
{
    KZS_OPENGL_CALL_BEGIN
        glInvalidateFramebuffer(target, num, targetsEnum);
    kzsGlErrorTest();
    KZS_OPENGL_CALL_END
}
