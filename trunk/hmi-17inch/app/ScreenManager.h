...
class ScreenManager : public QObject
{
    ...
    Q_PROPERTY(bool isInNavi READ isInNavi WRITE  setIsInNavi)
    //Q_PROPERTY(bool isFirstStartNavi READ isFirstStartNavi WRITE  setIsFirstStartNavi)
    Q_ENUMS(Screen)
...
public:
    ...
    bool isInNavi();
    void setIsInNavi(bool );
//    bool isFirstStartNavi();
//    void setIsFirstStartNavi();
