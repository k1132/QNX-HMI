...
Item {
    ...
    Component.onCompleted: {
        ...
        if(_mediaPlayerModule.musicFirstRunFlag){
            _mediaPlayerModule.m_circleMode = 0;
            _mediaPlayerModule.setMusicFirstRunFlag(false)

            if(_mediaPlayerModule.musicFileExist())
            {
        ...
        {
            btn_circle_mode.currentColumn = _mediaPlayerModule.m_circleMode;
        }
    ...
    MultiStateButton{
        ...
        onBtn_Released: {
            ...
            if(currentColumn === 0){
                ...
                _mediaPlayerModule.m_circleMode = 1;
                _mediaPlayerModule.repeat(RepeatMode.ONE)
            }
            else if(currentColumn === 2){
                _mediaPlayerModule.m_circleMode = 2;
