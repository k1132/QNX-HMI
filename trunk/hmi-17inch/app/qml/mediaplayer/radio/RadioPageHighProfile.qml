...
Item {
    ...
    ChickableButton{
        ...
        onBtn_Pressed: {
            ...
            _cardoorcontrol.setAmfm_state(0)
            /* display FM channel in right area **/
        }
    }

    /* AM FM switch and update radio func*/

    Connections
    {
      target: _radio
      onPresetStationsChanged:{
          channelid1.text = _radio.presetStations[0] + "MHz"
          channelid2.text = _radio.presetStations[1] + "MHz"
          channelid3.text = _radio.presetStations[2] + "MHz"
          channelid4.text = _radio.presetStations[3] + "MHz"
          channelid5.text = _radio.presetStations[4] + "MHz"
          channelid6.text = _radio.presetStations[5] + "MHz"
      }
    ...
    Connections
    {
      target: _radio
      onStationChanged:{
         console.log("onStationChanged");
         current_fm_frequence.text = _radio.station.toFixed(1)
         _cardoorcontrol.setAmfm_value(_radio.station)
      }
    }
    ChickableButton{
    ...
    ChickableButton{
        ...
        onBtn_Pressed: {
            if(!isSeeking){
                /* display AM  Or FM channel in right area **/
