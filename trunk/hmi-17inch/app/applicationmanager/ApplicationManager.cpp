    ...
    , m_externalApplicationLaunching(true)
{
  ...
  /**
    m_ppsObject = new QPps::Object(QStringLiteral("/pps/hinge-tech/qnxcar/app"), QPps::Object::PublishAndSubscribeMode, true, this);
...
{
    system("/extra/Hinge_Apps/scripts/apploading.sh start &");
    ...
    {
        system("/extra/Hinge_Apps/scripts/fixbt.sh &");
    }
