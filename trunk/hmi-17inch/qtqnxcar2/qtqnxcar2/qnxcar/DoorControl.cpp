...
CarDoorControl::Private::Private(CarDoorControl *qq)
    ...
    , m_pm_2_5_state(1)
{
    m_ppsObject = new QPps::Object(QStringLiteral("/pps/hinge-tech/ui"), QPps::Object::PublishAndSubscribeMode, true, this);
...
void CarDoorControl::setUi_style(int ui_style)
{
    ...
    if(ui_style == 1)
    {
        system("echo ui_style::1 >> /pps/hinge-tech/ui &");
    }
    else if(ui_style == 2)
    {
        system("echo ui_style::2 >> /pps/hinge-tech/ui &");
    }
    else if(ui_style == 3)
    {
        system("echo ui_style::3 >> /pps/hinge-tech/ui &");
    }
