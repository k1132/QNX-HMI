...
class QTQNXCAR2_EXPORT Radio : public QObject
{
    ...
    Q_PROPERTY(bool audios READ audios WRITE setAudios NOTIFY audiosChanged)
    ...
    Q_PROPERTY(QString seekState READ seekState NOTIFY seekStateChanged)
...
Q_SIGNALS:
    ...
    void audiosChanged(bool audios);
